...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        out_path = f"./mmlu_dataset/PG_Benchmark/sampled_mmlu_test_data_user_{i}_results_filtered_LLM_Judge_DeepSeek.json"
    ...
    summary_csv_path = "./mmlu_dataset/PG_Benchmark/llm_models_timing_summary_DeepSeek.csv"
